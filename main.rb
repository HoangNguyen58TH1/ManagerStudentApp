...
arr_student = [
  { name: 'Hoang', age: 22, address: 'Nha Trang', date_of_birth: Time.local(1998, 8, 20), mode: "basic", years: 3, score: 3.5 },
  { name: 'Linh', age: 23, address: 'Diên Khánh', date_of_birth: Time.local(1998, 1, 1), mode: "advanced", years: 4, score: 4.5, certificate: 'yes' },
...
student_manager = StudentManager.new(students)
# student_manager.print_info()
student_manager.classify_student_mode
puts '=========================================='
student_manager.classify_student_score
